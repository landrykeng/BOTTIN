...
def show():
    ...
    with col_form:
        with st.form("inscription_form"):
            ...
            submitted = st.form_submit_button(":material/send: Soumettre la demande", use_container_width=True, type="primary")
            ...
            if submitted:
                ...
                if errors:
                    ...
                    if success:
                        st.success(f":material/check_circle: Demande enregistrée avec succès ! Votre dossier est en attente de validation par l'administrateur BEAC. Vous recevrez une notification à l'adresse **{email}**.")
                    else:
    ...
    with col_info:
        ...
        st.markdown("""
        <div class="app-card">
            <div style="font-weight:700; color:#003366; margin-bottom:0.5rem;">:material/schedule: Délai de traitement</div>
            <div style="font-size:0.88rem; color:#4A4A4A;">Votre dossier sera examiné sous <strong>5 jours ouvrés</strong> par l'équipe BEAC/CRCT.</div>
        </div>
        <br>
        <div class="app-card">
            <div style="font-weight:700; color:#003366; margin-bottom:0.5rem;">:material/verified: Validation manuelle</div>
            <div style="font-size:0.88rem; color:#4A4A4A;">Aucun accès automatique — chaque demande est vérifiée individuellement.</div>
        </div>
        <br>
        <div class="app-card">
            <div style="font-weight:700; color:#003366; margin-bottom:0.5rem;">:material/lock: Données sécurisées</div>
            <div style="font-size:0.88rem; color:#4A4A4A;">Vos informations sont protégées conformément aux standards de sécurité de la BEAC.</div>
        </div>
        ...
        **BEAC — CRCT**  
        ...
        :material/location_on: Avenue Monseigneur Vogt, Yaoundé, Cameroun  
        """)
